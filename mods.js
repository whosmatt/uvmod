modClasses = [
    ...
    class Mod_FrequencyRangeSimple extends FirmwareMod {
        constructor() {
            super("Larger RX Frequency Range", "Changes the lower limit of Band 1 to 18 MHz and the upper limit of Band 7 to 999 MHz for RX. TX ranges are not affected. ", 0);
        }
